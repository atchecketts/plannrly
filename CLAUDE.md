...
- For views, use components that are already available in the `resources/views/components` directory or consider creating a new component if reusable patterns emerge.

## Task Completion

- After completing any feature or fix, you MUST:

...
<nav class="fixed bottom-0 left-0 right-0 bg-gray-900 border-t border-gray-800 lg:hidden safe-area-bottom z-50">
    <div class="grid grid-cols-5 h-16 max-w-lg mx-auto">
        ...
        <a href="{{ route('time-clock.index') }}"
           class="flex flex-col items-center justify-center">
            <div class="w-14 h-14 -mt-8 bg-brand-600 rounded-full flex items-center justify-center shadow-lg border-4 border-gray-950">

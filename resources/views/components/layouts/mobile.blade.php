    ...
    <div x-data="{ menuOpen: false }" class="flex flex-col h-full">
        ...
        <nav class="bg-gray-900 border-t border-gray-800 px-2 py-2">
            <div class="flex justify-around">
                ...
                <a href="{{ route('my-shifts.index') }}" class="flex flex-col items-center px-3 py-2 rounded-lg {{ $active === 'shifts' ? 'text-brand-400' : 'text-gray-500 hover:text-gray-300' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    <span class="text-xs mt-1">Shifts</span>
                </a>
                <a href="{{ route('time-clock.index') }}" class="flex flex-col items-center px-3 py-2 rounded-lg {{ $active === 'clock' ? 'text-brand-400' : 'text-gray-500 hover:text-gray-300' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span class="text-xs mt-1">Clock</span>
                </a>
                <a href="{{ route('profile.show') }}" class="flex flex-col items-center px-3 py-2 rounded-lg {{ $active === 'profile' ? 'text-brand-400' : 'text-gray-500 hover:text-gray-300' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>

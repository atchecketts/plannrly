        ...
        <div x-show="menuOpen"
            ...
            <div class="flex-1 overflow-y-auto py-2">
                ...
                <div class="px-3 mb-4">
                    ...
                    <a href="{{ route('my-shifts.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ $active === 'shifts' ? 'bg-brand-900/20 text-brand-400' : 'text-gray-300 hover:bg-gray-800' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        My Shifts
                    </a>
                    <a href="{{ route('time-clock.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ $active === 'clock' ? 'bg-brand-900/20 text-brand-400' : 'text-gray-300 hover:bg-gray-800' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        Time Clock
                    </a>
                    <a href="{{ route('my-swaps.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ $active === 'swaps' ? 'bg-brand-900/20 text-brand-400' : 'text-gray-300 hover:bg-gray-800' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Leave -->
                <div class="px-3 mb-4">
                    <p class="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Leave</p>
                    <a href="{{ route('my-leave.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-300 hover:bg-gray-800">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                        </svg>
                        My Leave Requests
                    </a>
                    <a href="{{ route('my-leave.create') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-300 hover:bg-gray-800">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

    ...
    <div x-data="{ menuOpen: false }" class="flex flex-col h-full">
        ...
        <div x-show="menuOpen"
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-brand-300">{{ auth()->user()->getHighestRole()?->label() ?? 'Admin' }}</p>
                        </div>
                    </div>
            ...
            <div class="flex-1 overflow-y-auto py-2">
                ...
                <div class="px-3 mb-4">
                    ...
                    <a href="{{ route('schedule.mobile') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ $active === 'schedule' ? 'bg-primary-600/20 text-brand-300 border border-primary-600/30' : 'text-surface-300 hover:bg-surface-800 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        Schedule
                    </a>
                    <a href="{{ route('users.mobile') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ $active === 'team' ? 'bg-primary-600/20 text-brand-300 border border-primary-600/30' : 'text-surface-300 hover:bg-surface-800 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                        Team
                    </a>
                    <a href="{{ route('leave-requests.mobile') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ $active === 'requests' ? 'bg-primary-600/20 text-brand-300 border border-primary-600/30' : 'text-surface-300 hover:bg-surface-800 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                        </svg>
                        Leave Requests
                    </a>
                    <a href="{{ route('shift-swaps.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-surface-300 hover:bg-surface-800 hover:text-white">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Settings -->
                <div class="px-3 mb-4">
                    <p class="px-3 text-xs font-semibold text-surface-500 uppercase tracking-wider mb-2">Settings</p>
                    <a href="{{ route('locations.mobile') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ $active === 'locations' ? 'bg-primary-600/20 text-brand-300 border border-primary-600/30' : 'text-surface-300 hover:bg-surface-800 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('departments.mobile') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ $active === 'departments' ? 'bg-primary-600/20 text-brand-300 border border-primary-600/30' : 'text-surface-300 hover:bg-surface-800 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                        </svg>
                        Departments
                    </a>
                    <a href="{{ route('business-roles.mobile') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg {{ $active === 'roles' ? 'bg-primary-600/20 text-brand-300 border border-primary-600/30' : 'text-surface-300 hover:bg-surface-800 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-4 border-t border-surface-700">
                <a href="{{ route('schedule.index') }}" class="flex items-center justify-center gap-2 w-full py-2.5 text-sm text-surface-400 hover:text-white bg-surface-800 hover:bg-surface-700 rounded-lg transition-colors">
        ...
        <nav class="bg-surface-900 border-t border-surface-700 px-2 py-2">
            <div class="flex justify-around">
                ...
                <a href="{{ route('schedule.mobile') }}" class="flex flex-col items-center px-3 py-2 rounded-lg {{ $active === 'schedule' ? 'text-brand-400' : 'text-surface-500 hover:text-surface-300' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    <span class="text-xs mt-1">Schedule</span>
                </a>
                <a href="{{ route('users.mobile') }}" class="flex flex-col items-center px-3 py-2 rounded-lg {{ $active === 'team' ? 'text-brand-400' : 'text-surface-500 hover:text-surface-300' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    <span class="text-xs mt-1">Team</span>
                </a>
                <a href="{{ route('leave-requests.mobile') }}" class="flex flex-col items-center px-3 py-2 rounded-lg {{ $active === 'requests' ? 'text-brand-400' : 'text-surface-500 hover:text-surface-300' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                    </svg>

    ...
    <div x-data="{ menuOpen: false }" class="flex flex-col h-full">
        ...
        <nav class="bg-gray-900 border-t border-gray-800 px-2 py-2">
            <div class="flex justify-around">
                ...
                <a href="{{ route('schedule.mobile') }}" class="flex flex-col items-center px-2 py-2 rounded-lg {{ $active === 'schedule' ? 'text-brand-400' : 'text-gray-500 hover:text-gray-300' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    <span class="text-xs mt-1">Schedule</span>
                </a>
                <a href="{{ route('users.mobile') }}" class="flex flex-col items-center px-2 py-2 rounded-lg {{ $active === 'team' ? 'text-brand-400' : 'text-gray-500 hover:text-gray-300' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    <span class="text-xs mt-1">Team</span>
                </a>
                <a href="{{ route('leave-requests.mobile') }}" class="flex flex-col items-center px-2 py-2 rounded-lg {{ $active === 'requests' ? 'text-brand-400' : 'text-gray-500 hover:text-gray-300' }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                    </svg>

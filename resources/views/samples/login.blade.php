            ...
            <div class="w-full max-w-md">
                ...
                <form class="space-y-5">
                    <div>
                        ...
                        <input type="email" placeholder="you@company.com" class="w-full px-4 py-3 bg-gray-800 border border-gray-700 text-white placeholder-gray-500 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-colors">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" placeholder="Enter your password" class="w-full px-4 py-3 bg-gray-800 border border-gray-700 text-white placeholder-gray-500 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-colors">
                    </div>

                    <div class="flex items-center">
                        <input type="checkbox" id="remember" class="w-4 h-4 text-brand-600 bg-gray-800 border-gray-600 rounded focus:ring-brand-500">
                ...
                <div class="mt-8">
                    ...
                    <a href="/samples/register" class="mt-4 w-full flex items-center justify-center gap-2 border border-gray-700 text-gray-300 py-3 px-4 rounded-lg font-medium hover:bg-gray-800 transition-colors">
                        Create an account

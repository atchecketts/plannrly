<x-layouts.app title="Edit Location">
    <form action="{{ route('locations.update', $location) }}" method="POST" class="space-y-8">
        @csrf
        @method('PUT')
        ...
        <div class="rounded-lg bg-white p-6 shadow">
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="address_line_1" id="address_line_1" value="{{ old('address_line_1', $location->address_line_1) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                </div>
        ...
        <div class="flex justify-end gap-3">
            <a href="{{ route('locations.show', $location) }}" class="rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                Cancel
            </a>

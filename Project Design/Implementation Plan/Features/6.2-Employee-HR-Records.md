...
- [ ] Create migration for user_employment_details table
- [ ] Create UserEmploymentDetails model with casts and accessors
- [ ] Create EmploymentStatus enum
- [ ] Create PayType enum
- [ ] Create UserEmploymentDetailsPolicy
- [ ] Create EmploymentDetailsController
- [ ] Create employment details form (tab on user edit page)
- [ ] Implement pay rate hierarchy logic (getEffectiveHourlyRate method)
- [ ] Add employment status badges to user list
- [ ] Show employees on notice period/leaving soon on dashboard
